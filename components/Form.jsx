...
const Form = ({
  ...
  return (
    <section className='w-full max-w-full flex-start flex-col'>
      ...
      <h1 className='head_text test_left'>
      ...
      <p className='desc text-left max-w-md'>
        {type} and share amazing prompt with world and run wild with any AI-powered platform.
      </p>

      <form
        onSubmit={handleSubmit}
        className='mt-10 w-fill max-w-2xl flex-col gap-7 glassmorphism'>
